...
void UGrim_ESMovementComponent::Initialize(ACharacter* character)
{
	...
	_characterMovement->RotationRate = FRotator(0, 345, 0); // The rate at which the player character turns around
	_characterMovement->AirControl = 0.4; // The amount of control (%) a player has in the air compared to the ground
}
